...
function editor(state) {
  ...
  const canEditCalls = draft.mode === "create" || basicCompatible(doc, calls);
  ...
  return `<form class="metrix-stack metrix-plan-editor" data-plan-form
    ...
    <div class="card">
      ...
      <div class="card-body border-top text-secondary metrix-plan-explanation">
        ${canEditCalls
          ? "Each row is one call. Its RPS determines the stored rate and percentages. Type a path to add a method/path call."
